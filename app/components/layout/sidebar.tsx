...
export default function Sidebar() {
  return (
    <div className=" hidden w-1/6 justify-end rounded-xl bg-[#23273C] md:flex xl:p-5">
      <ul className="">
        <Link
          href="/dashboard"
          className="my-5 mb-2 flex  cursor-pointer justify-end rounded px-4 py-2 text-end font-medium  capitalize hover:bg-purple-800 md:text-sm lg:text-lg dark:bg-purple-600 dark:hover:bg-purple-700 dark:focus:ring-purple-900"
        >
        ...
        <Link
          ...
          className="my-5 mb-2 flex w-full cursor-pointer justify-end rounded px-4 py-1 text-end font-medium  capitalize hover:bg-purple-800 md:text-sm lg:text-lg dark:bg-purple-600 dark:hover:bg-purple-700 dark:focus:ring-purple-900"
        >
